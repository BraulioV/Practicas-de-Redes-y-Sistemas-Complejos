...
cienciogramas = ["France-2002.net", "Germany-2002.net", "Japan-2002.net",
                 "Spain-1996.net", "Spain-1998.net", "Spain-2002.net",
                 "Spain-2004.net", "United_Kingdom-2002.net",
                 "United_States-2002.net", "World.net",]
...
def get_num_vertex(cienciograma):
    with open("./cienciogramas/selected/" + cienciograma, 'r') as f:
...
for cg in cienciogramas:
    ...
    for q in qs + [cg[1]]:
        # podamos la red
        proc = Popen(["./Pathfinder_src/BinaryPathfinder/binary-pathfinder", "./cienciogramas/selected/" + cg[0], str(q)], stdout=PIPE)
